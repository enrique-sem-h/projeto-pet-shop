...
export class TablesSetup1782408414194 implements MigrationInterface {
    name = 'TablesSetup1782408414194'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "pets" ADD CONSTRAINT "FK_eb990a74dbc1c946095cba08d38" FOREIGN KEY ("tutor_id") REFERENCES "tutors"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
